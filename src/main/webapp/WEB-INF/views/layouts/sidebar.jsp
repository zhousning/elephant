		...
		<ul id="menu-content" class="menu-content collapse out">
			...
			active"><a><i
				...
				<ul class="sub-menu collapse" id="centers">
					<li><a href="centers/index"><fmt:message key="centers.index"></fmt:message></a></li>
				...
				<li data-toggle="collapse" data-target="#departments"
					class="collapsed
			active"><a><i
						class="fa fa-gift fa-lg"></i> <fmt:message key="departments.manage"></fmt:message>
						<span class="arrow"></span></a></li>
				<ul class="sub-menu collapse" id="departments">
					<li><a href="departments/index"><fmt:message key="departments.index"></fmt:message></a></li>
					<li><a href="departments/new"><fmt:message key="departments.new"></fmt:message></a></li>
				</ul>
			...
			active"><a><i
				...
				<ul class="sub-menu collapse" id="exaccts">
					<li><a href="exacctOnes/index"><fmt:message key="exacctOnes.index"></fmt:message></a></li>
					<li><a href="exacctTwos/index"><fmt:message key="exacctTwos.index"></fmt:message></a></li>
					<li><a href="exacctThrees/index"><fmt:message key="exacctThrees.index"></fmt:message></a></li>
				</ul>
