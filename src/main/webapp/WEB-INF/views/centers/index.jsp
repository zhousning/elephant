...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="centers.index"></fmt:message></title>
<%@ include file="/WEB-INF/views/layouts/common.jsp"%>
<link href="static/stylesheets/centers.css" rel="stylesheet">
<script src="static/javascripts/centers.js"></script>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="centers.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="centers/new" class="btn btn-primary btn-block"> <fmt:message
						...
						<thead>
							<tr class="text-center">
								...
								<th data-field="name" data-filter-control="input"><fmt:message
										key="center.name"></fmt:message></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<c:if test="${ !empty centers }">
								<c:forEach items="${ centers }" var="center"
									...
									<tr>
										...
										<td>${ center.name }</td>
										<td><a href="centers/${center.id }" class="btn btn-info"><fmt:message
													key="btn.info"></fmt:message></a> <a
											href="centers/${center.id }/edit" class="btn btn-success"><fmt:message
													key="btn.edit"></fmt:message></a> <a href="centers/${center.id}/destroy"
