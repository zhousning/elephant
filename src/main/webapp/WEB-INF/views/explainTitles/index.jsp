...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="explainTitles.index"></fmt:message></title>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="explainTitles.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="explainTitles/new" class="btn btn-primary btn-block"> <fmt:message
						...
						<thead>
							<tr class="text-center">
								...
								<th data-field="name" data-filter-control="input"><fmt:message
										key="explainTitle.name"></fmt:message></th>
								<th data-field="order" data-filter-control="input"><fmt:message
										key="explainTitle.order"></fmt:message></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<c:if test="${ !empty explainTitles }">
								<c:forEach items="${ explainTitles }" var="explainTitle"
									varStatus="status">
									<tr>
										<td>${ status.index + 1 }</td>
										<td>${ explainTitle.name }</td>
										<td>${ explainTitle.order }</td>
										<td><a href="explainTitles/${explainTitle.id }" class="btn btn-info"><fmt:message
													key="btn.info"></fmt:message></a> <a
											href="explainTitles/${explainTitle.id }/edit" class="btn btn-success"><fmt:message
													key="btn.edit"></fmt:message></a> <a href="explainTitles/${explainTitle.id}/destroy"
