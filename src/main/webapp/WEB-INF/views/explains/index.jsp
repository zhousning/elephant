...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="explains.index"></fmt:message></title>
<%@ include file="/WEB-INF/views/layouts/common.jsp"%>
<link href="static/stylesheets/explains.css" rel="stylesheet">
<script src="static/javascripts/explains.js"></script>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="explains.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="explains/new" class="btn btn-primary btn-block"> <fmt:message
						...
						<thead>
							<tr class="text-center">
								...
								<th data-field="name" data-filter-control="input"><fmt:message
										key="explain.name"></fmt:message></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<c:if test="${ !empty explains }">
								<c:forEach items="${ explains }" var="explain"
									varStatus="status">
									<tr>
										<td>${ status.index + 1 }</td>
										<td>${ explain.name }</td>
										<td><a href="explains/${explain.id }" class="btn btn-info"><fmt:message
													key="btn.info"></fmt:message></a> <a
											href="explains/${explain.id }/edit" class="btn btn-success"><fmt:message
													key="btn.edit"></fmt:message></a> <a href="explains/${explain.id}/destroy"
