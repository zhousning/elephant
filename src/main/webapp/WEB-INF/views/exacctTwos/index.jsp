...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title><fmt:message key="exacctTwos.index"></fmt:message></title>
			...
			<div class="col-md-10 main-container">
				...
				<div class="container-fluid">
					<div class="page-header">
						<h1>
							<fmt:message key="exacctTwos.index"></fmt:message>
						</h1>
					</div>
					<div class="row">
						<div class="col-md-1">
							<a href="exacctTwos/new" class="btn btn-primary btn-block"> <fmt:message
						...
						<thead>
							<tr class="text-center">
								...
								<th data-field="name" data-filter-control="input"><fmt:message
										key="exacctTwo.name"></fmt:message></th>
								<th></th>
							</tr>
						</thead>
						<tbody>
							<c:if test="${ !empty exacctTwos }">
								<c:forEach items="${ exacctTwos }" var="exacctTwo"
									varStatus="status">
									<tr>
										<td>${ status.index + 1 }</td>
										<td>${ exacctTwo.name }</td>
										<td><a href="exacctTwos/${exacctTwo.id }" class="btn btn-info"><fmt:message
													key="btn.info"></fmt:message></a> <a
											href="exacctTwos/${exacctTwo.id }/edit" class="btn btn-success"><fmt:message
													key="btn.edit"></fmt:message></a> <a href="exacctTwos/${exacctTwo.id}/destroy"
