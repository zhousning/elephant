...
public class ${model.name} {
	...
	private Set<${model.associateObjects[associate_index]?cap_first}> ${model.associateObjects[associate_index]?uncap_first}s = new LinkedHashSet<${model.associateObjects[associate_index]?cap_first}>();
